using GLJ.Controllers;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using System;
using Microsoft.VisualStudio.TestTools.UnitTesting.Web;
using System.Web.Mvc;

namespace GLJWebTest
{
    ...
    public class AgendaControllerTest
    {
        ...
        public void BuscarEventosTest()
        {
            ...
            double start = 0F; // TODO: Initialize to an appropriate value
            double end = 0F; // TODO: Initialize to an appropriate value
            JsonResult expected = null; // TODO: Initialize to an appropriate value
            JsonResult actual;
            actual = target.BuscarAgenda(start, end);
